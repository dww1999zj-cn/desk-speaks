...
export default function PersonaUploadPage() {
  const router = useRouter();
  const t = useTranslations("personaUpload");
  ...
  const handleAnalyze = () => {
    ...
    const go = () => router.push("/persona/analyzing");
    ...
    <GradientBackground>
      <main className="mx-auto flex min-h-dvh max-w-lg flex-col px-6 py-12 safe-bottom">
        ...
        <section className="mt-8 flex-1">
          <PhotoUploader i18nNamespace="personaUpload" onImageReady={handleImageReady} />
        </section>
