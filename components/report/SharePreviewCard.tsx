      ...
      <div className="relative overflow-visible rounded-[1.75rem] border border-plant/20 bg-gradient-to-br from-[#F7F6F3] via-[#EEEDE8] to-[#E8EDE6] p-5 shadow-lg shadow-plant/15">
        ...
        {deskThumb ? (
          <div className="relative mt-4 overflow-visible">
            <div className="overflow-hidden rounded-2xl border border-plant/15 bg-[#E8EDE6]/80 shadow-md shadow-plant/10">
              ...
              <div className="px-4 py-5 text-center">
                ...
                <p className="mt-2 font-display text-4xl font-semibold leading-none text-plant">
            ...
            {/* 骑缝章：定位层与动画分离，章心压在图/价接缝 */}
            <div className="pointer-events-none absolute inset-x-0 top-0 z-20 aspect-[3/2]">
              <div className="absolute left-[78%] top-full -translate-x-1/2 -translate-y-1/2">
                <CertificationStamp />
              </div>
            </div>
          </div>
        ) : (
          <div className="relative mt-4 overflow-visible rounded-2xl bg-plant/10 px-4 py-5 text-center">
            <CertificationStamp className="pointer-events-none absolute right-0 top-0 z-0 translate-x-[38%] -translate-y-[48%]" />
            <div className="relative z-10">
              <p className="text-xs text-muted">{t("salaryGuessLabel")}</p>
              <p className="mt-3 font-display text-4xl font-semibold leading-none text-plant">
                {report.salary.guessedSalary}
              </p>
            </div>
          </div>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          {!deskThumb && report.shareCard.summary ? (
