/** 京粉推广链接：在京东京粉 App 生成后替换 affiliateUrl */
...
export const OFFICE_PICKS: OfficePick[] = [
  {
    id: "desk-organizer",
    category: "桌面收纳",
    name: "桌面抽屉收纳盒",
...
export function getOfficePicksByCategory(category: string): OfficePick[] {
  return OFFICE_PICKS.filter((pick) => pick.category === category);
}
